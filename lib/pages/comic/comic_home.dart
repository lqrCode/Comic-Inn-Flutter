  ...
  Widget get homeBanner => Container(
        ...
        child: Swiper(
          ...
          onTap: (int i) {
            // Navigator.push(
            //   context,
            //   AnimationRoute(WebviewScaffold(url: lists[i].url, appBar: AppBar(title: Text(lists[i].title))), true),
            // );
          },
        ),
      );
                      ...
                      .map(
                        (e) => Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Container(
                                decoration: BoxDecoration(borderRadius: Lqr.ui.borderRadius()),
                                child: Stack(
                                  children: <Widget>[
                                    LqrImage(width: 195, height: 260, src: e.image),
